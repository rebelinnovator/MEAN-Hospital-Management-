...
@Component({
  selector: 'app-service-user-background',
  templateUrl: './service-user-background.component.html'
})
export class ServiceUserBackgroundComponent implements OnInit {
  ...
  onReactiveFormSubmit() {
    ...
    if (this.regularForm.value.service_user_assisting_device === null || this.regularForm.value.service_user_assisting_device === 'null') {
